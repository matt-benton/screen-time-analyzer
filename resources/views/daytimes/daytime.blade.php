...
<div class="container">
    <div class="row justify-content-center pb-3">
        <div class="col-md-8">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/daytimes">Daytimes</a></li>
                <li class="breadcrumb-item active">{{ $daytime->name }}</li>
            </ol>
        </div>
    </div>
    <div class="row justify-content-center pb-3" style="display:none" id='delete-alert-container'>
        <div class="col-md-8">
            <div class="alert alert-danger">
                <div class="row">
                    <div class="col-md-6" style="padding-top:6px">Delete this daytime?</div>
                    <div class="col-md-6 text-right">
                        <form action="/daytimes/{{ $daytime->id }}" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        <div class="col-md-8">
            <form action="/daytimes/{{ $daytime->id }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-input" name="name" value="{{ $daytime->name }}">
                </div>
                <div class="form-group">
                    <label for="description-textarea">Description</label>
                    <textarea class="form-control" id="description-textarea" name="description">{{ $daytime->description }}</textarea>
                </div>
                <div class="row justify-content-end pr-3">
                    ...
                    <a href="/daytimes"><button type="button" class="btn btn-outline-secondary">Back</button></a>
                </div>
            </form>
        </div>
    </div>
