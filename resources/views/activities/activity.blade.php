    ...
    <div class="row justify-content-center pb-3" style="display:none" id='delete-alert-container'>
        <div class="col-md-8">
            <div class="alert alert-danger">
                <div class="row">
                    <div class="col-md-6" style="padding-top:6px">Delete this activity?</div>
        ...
        <div class="col-md-8">
            <form action="/activities/{{ $activity->id }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name-input" name="name" value="{{ $activity->name }}">
                </div>
                <div class="form-group">
                    <label for="description-textarea">Description</label>
                    <textarea class="form-control" id="description-textarea" name="description">{{ $activity->description }}</textarea>
                </div>
                <div class="row justify-content-end pr-3">
                    ...
                    <a href="/activities"><button type="button" class="btn btn-outline-secondary">Back</button></a>
                </div>
            </form>
        </div>
    </div>
